...
import com.google.android.fhir.khisapp.engine.FhirApplication
...
// Print the response to the log
        ...
        lifecycleScope.launch {
            ...
            if (QuestionnaireResponseValidator.validateQuestionnaireResponse(
                ...
                Toast.makeText(this@AddRecord, "failed to submit", Toast.LENGTH_SHORT).show()
            ...
            if (entry.resource !is Patient) {
                ...
                Toast.makeText(this@AddRecord, "resource type = $resourse_entry", Toast.LENGTH_SHORT).show()
                return@launch
            }
            ...
            Toast.makeText(this@AddRecord, "data submitted suuccessfully", Toast.LENGTH_SHORT).show()
